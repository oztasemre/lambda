...
public static void arrtolist( Integer arr1 []){
    ...
    public static void arrToplam( Integer arr1 []){
        System.out.println(Arrays.stream(arr1).reduce(Integer::sum).map(t->t/ arr1.length));


    }
    // S3: Array in elemanlarinin ortalamasini bulalim yazdir

    public static void arrOrt( Integer arr1 []){
